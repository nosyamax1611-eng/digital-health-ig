...
Alias: $claim-decision = http://hl7.org/fhir/ValueSet/claim-decision
Alias: $claim-response-outcome = http://hl7.org/fhir/ValueSet/claim-outcome
Alias: $claim-response-category = http://hl7.org/fhir/ValueSet/adjudication
Alias: $claim-type = http://hl7.org/fhir/ValueSet/claim-type
Alias: $claim-use = http://hl7.org/fhir/ValueSet/claim-use
Alias: $claim-status = http://hl7.org/fhir/ValueSet/fm-status
...
Alias: $task-intent-cs = https://terminology.dhp.uz/fhir/core/CodeSystem/task-intent-cs
Alias: $task-code-cs = https://terminology.dhp.uz/fhir/core/CodeSystem/task-code-cs
